...
def visualize_one_slice_in_3d(
    image, axis: int = 2, center=None, mask_bool=True, n_label=105, colorize=None
):
    """
...
def get_xyz_plot(
    image, center_loc_axis, mask_bool=True, n_label=105, colorize=None, target_class_index=0
):
    """
