...
from .utils import (
    define_instance,
    prepare_maisi_controlnet_infer_dataloader,
...
def main():
    ...
    if args.trained_diffusion_path is not None:
        ...
        diffusion_model_ckpt = torch.load(
            args.trained_diffusion_path, map_location=device, weights_only=False
        )
    ...
    if args.trained_controlnet_path is not None:
        ...
        controlnet.load_state_dict(
            torch.load(args.trained_controlnet_path, map_location=device, weights_only=False)[
    ...
    for batch in val_loader:
        ...
        modality_tensor = args.controlnet_infer["modality"] * torch.ones(
        ...
        synthetic_images, _ = ldm_conditional_sample_one_image(
            ...
            autoencoder_sliding_window_infer_overlap=args.controlnet_infer[
