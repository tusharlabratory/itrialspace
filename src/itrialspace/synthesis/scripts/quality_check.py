...
def is_outlier(statistics, image_data, label_data, label_int_dict):
    ...
    for label_name, stats in statistics.items():
        ...
        low_thresh = min(
            stats["sigma_6_low"], stats["percentile_0_5"]
        )  # or "sigma_12_low" depending on your needs
        high_thresh = max(
            stats["sigma_6_high"], stats["percentile_99_5"]
        )  # or "sigma_12_high" depending on your needs
